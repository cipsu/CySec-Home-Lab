...
![Metasploit console open on AttackBox](../screenshots/33-metasploit-open.png)
...
![Metasploit showing psexec options set and session opened](../screenshots/33-set-smb-login.png)
...
![sysinfo showing computer name and domain](../screenshots/33-run-sysinfo.png)
...
![enum_shares output showing user-created share](../screenshots/33-run-enum-shares.png)
...
![hashdump showing NTLM hashes for all local users](../screenshots/33-hashdump.png)
...
![Meterpreter search returning full path of secrets.txt](../screenshots/33-search-secrets.png)

### Screenshot — Contents of secrets.txt

![secrets.txt contents showing Twitter password](../screenshots/33-cat-secrets.png)

### Screenshot — Search for realsecret.txt

![Meterpreter search returning full path of realsecret.txt](../screenshots/33-search-realsecret.png)

### Screenshot — Contents of realsecret.txt

![realsecret.txt contents showing final answer](../screenshots/33-cat-realsecret.png)
